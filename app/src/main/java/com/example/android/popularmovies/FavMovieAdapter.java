...
public class FavMovieAdapter extends RecyclerView.Adapter<FavMovieAdapter.ViewHolder> {
    ...
    private final String LOG_TAG = FavMovieAdapter.class.getSimpleName();
    ...
    public FavMovieAdapter(Context context, ArrayList<MovieData> m_data){
    ...
    @Override
    public FavMovieAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
